...
// You can use the same URL for GET (display form) and POST (submit form) if you prefer:
// Route::get('/register', function () { return view('auth.signup'); })->name('register.show');
// Route::post('/register', [RegisterController::class, 'store'])->name('register.store');
