...
<div class="container container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button class="btn btn-primary"><i class="fa fa-download me-2"></i>Export Report</button>
    </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm p-3 border-start border-warning border-4">
                ...
                <h3 class="mb-0 text-warning">{{ $orders->where('status', 'pending')->count() }}</h3>
            </div>
        </div>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <span class="badge bg-danger-subtle text-danger px-3">{{ ucfirst($order->status) }}</span>
                                @endif
                            </td>
                            <td class="text-end pe-3">
                                <a href="{{ route('admin.orders.show', $order->id) }}" class="btn btn-sm btn-outline-dark me-1">
                                    <i class="fa fa-eye"></i>
                                </a>
                                <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#editStatus{{ $order->id }}">
